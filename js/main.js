...
btnRedes.addEventListener('click',(e)=>{
  if (e.target.classList.contains('card__btnRedes')) {
    ...
    e.target.firstElementChild.lastElementChild.classList.toggle("card__iconoShareRedes--show")
    e.target.nextElementSibling.classList.toggle("card__contenRedes--show")
  console.log(e)
  }
})